...
SC_MODULE(Gaussian_Smooth)
{
	...
	SC_CTOR(Gaussian_Smooth)
		: receiver("receiver"), g_kernel("g_kernel"), blurx("blurx"), blury("blury"), img_q1("img_q1", 1), img_q2("img_q2", 1), knl_q1("knl_q1", 1), knl_q2("knl_q2", 1), knl_q3("knl_q3", 1), tmp_q("tmp_q", 1), int_q1("int_q1", 1), int_q2("int_q2", 1), int_q3("int_q3", 1)
	{
...
SC_MODULE(DUT)
{
	...
	SC_CTOR(DUT)
		: q1("q1", 1), q2("q2", 1), q3("q3", 1), q4("q4", 1), q5("q5", 1), q6("q6", 1), q7("q7", 1), q3_bp("q3_bp", 1), q5_bp("q5_bp", 1), q7_bp("q7_bp", 1), nms("nms", 1)

		  ,
		  gaussian_smooth("gaussian_smooth"), derivative_x_y("derivative_x_y"), magnitude_x_y("magnitude_x_y"), non_max_supp("non_max_supp"), apply_hysteresis("apply_hysteresis")
...
SC_MODULE(Top)
{
	...
	SC_CTOR(Top)
		: q1("q1", 1), q2("q2", 1), qt("qt", 30), stimulus("stimulus"), platform("platform"), monitor("monitor")
	{
	}
};
